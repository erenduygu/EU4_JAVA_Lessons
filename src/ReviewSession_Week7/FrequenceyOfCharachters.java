...
public class FrequenceyOfCharachters {

	/*
	 * * Write a program that can return the frequency of each letter in the given
	 * String Ex: Input: "ABBBCCDEE" Output: A: 1 B: 3 C: 2 D: 1 E: 2
	 */
